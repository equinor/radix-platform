variable "storageaccounts" {
  ...
  type = map(object({
    name                     = string
    resource_group_name      = optional(string, "common-${destinationzone}") # template
    location                 = optional(string, "${location}")               # template
...
#   default = {
#     webconsole = {
#       display_name                 = "Omnia Radix Web Console - ${destinationzone}" # template
#       service_management_reference = "110327"
#       notes                        = "Omnia Radix Web Console - ${destinationzone}" # template
...
#     }
#     grafana = {
#       display_name                 = "radix-ar-grafana-${destinationzone}" # template
#       service_management_reference = "110327"
...
#     }
#     cr_cicd = {
#       display_name                       = "radix-cr-cicd-${destinationzone}" # template
#       service_management_reference       = "110327"
