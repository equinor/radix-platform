module "dns_zone" {
  ...
  dnszoneprefix        = "${prefix}{module.config.environment}."
}

module "radix-id-certmanager-mi" {
  source              = "../../../modules/userassignedidentity"
  name                = "radix-id-certmanager-${prefix}{module.config.environment}"
...
output "dns_zone_name" {
  value = "${prefix}{module.config.environment}.radix.equinor.com"
}