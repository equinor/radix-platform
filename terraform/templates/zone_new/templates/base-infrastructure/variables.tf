variable "storageaccounts" {
  ...
  type = map(object({
    name                     = string
    resource_group_name      = optional(string, "common-${zone}") # template
...
#   default = {
#     webconsole = {
#       display_name                 = "Omnia Radix Web Console - ${zone}" # template
#       service_management_reference = "110327"
#       notes                        = "Omnia Radix Web Console - ${zone}" # template
...
#     }
#     grafana = {
#       display_name                 = "radix-ar-grafana-${zone}" # template
#       service_management_reference = "110327"
...
#     }
#     cr_cicd = {
#       display_name                       = "radix-cr-cicd-${zone}" # template
#       service_management_reference       = "110327"
