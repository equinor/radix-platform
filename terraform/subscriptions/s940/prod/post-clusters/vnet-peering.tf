...
module "vnet_peering" {
  ...
  for_each                    = module.clusters.oidc_issuer_url
  hub_to_cluster_peering_name = "ANM_22740FFA83EB4B03043CC7E_vnet-hub_vnet-${each.key}_3520520940"
  cluster_to_hub_peering_name = "ANM_22740FFA83EB4B03043CC7E_vnet-${each.key}_vnet-hub_3520520940"
  cluster_resource_group      = "clusters" #TODO
