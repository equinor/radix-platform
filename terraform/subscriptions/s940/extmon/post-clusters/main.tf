...
data "azapi_resource_list" "clusters" {
  ...
  parent_id = "/subscriptions/${module.config.backend.subscription_id}/resourcegroups/monitoring" #TODO with code below after cluster in new RG
...
data "azurerm_kubernetes_cluster" "this" {
  ...
  resource_group_name = "monitoring" #TODO with code below after cluster in new RG
