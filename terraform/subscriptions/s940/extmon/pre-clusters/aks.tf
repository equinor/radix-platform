...
module "aks" {
  ...
  # enable_ddos_protection_plan       = module.config.environment == "platform" || module.config.environment == "c2"
  # enable_network_lock               = module.config.environment == "platform" || module.config.environment == "c2"
